...
import { FluidToggle } from "@/components/fluid-toggle";
...
export function Nav() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 w-full bg-background/40 backdrop-blur-sm md:sticky md:bg-background/30">
        <div className="flex items-center justify-between gap-4 py-4 max-w-7xl mx-auto px-6 md:px-8">
          ...
          <div className="flex md:hidden items-center">
            ...
            <button
              ...
              className="size-12 flex items-center justify-center rounded-md text-zinc-600 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-[60] md:hidden pointer-events-auto" aria-modal aria-label="Menu">
          <button
            type="button"
          ...
          />
          <div className="absolute top-0 left-0 right-0 w-full max-w-[100vw] rounded-b-xl bg-background/95 backdrop-blur-sm flex flex-col animate-in fade-in slide-in-from-top-4 duration-200 overflow-hidden pointer-events-auto">
            ...
            <div
              ref={panelRef}
              className="flex flex-col touch-none overflow-hidden pointer-events-auto"
